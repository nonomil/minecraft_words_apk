...
class MobileAppManager {
    ...
    setupRewardSync() {
        ...
        const syncRewards = () => {
            ...
            const mobileDiamonds = document.getElementById('mobileDiamonds');
            const mobileSwords = document.getElementById('mobileSwords');

            if (desktopDiamonds && mobileDiamonds) {
                mobileDiamonds.textContent = desktopDiamonds.textContent;
            }
            if (desktopSwords && mobileSwords) {
                mobileSwords.textContent = desktopSwords.textContent;
            }
        };
